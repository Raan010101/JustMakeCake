...
<body>
	...
	<div class="wrapper" id="wrapper">
					...
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								...
								<li class="drop with--one--item"><a href="shop-grid">Shop</a></li>
								<li class="drop with--one--item"><a href="build-a-cake">Build-A-Cake</a></li>
									...
									<ul class="item item03">
										...
										<ul class="item item03">
											<li class="title">Special Days</li>
											<li><a href="my-account">Birthday Cakes</a></li>
											<li><a href="cart">Mothers Day</a></li>
											<li><a href="checkout">Fathers Day</a></li>
											<li><a href="wishlist.html">Anniversary</a></li>
								...
								<li class="drop"><a href="shop-grid">Build-A-Cake</a>
								...
								<li class="drop"><a href="shop-grid">Cakes , Cakes , Cakes</a>
									<div class="megamenu mega01">
										<ul class="item item02">
										<li class="title">Special Days Cakes</li>
											<li><a href="my-account">Birthday Cakes</a></li>
											<li><a href="cart">Mothers Day Cakes</a></li>
											<li><a href="checkout">Fathers Day Cakes</a></li>
											<li><a href="wishlist.html">Anniversary Cakes</a></li>
											<li><a href="my-account">Teachers Day Cakes</a></li>
											<li><a href="cart">Friendship Cakes</a></li>

											
										</ul>
										<ul class="item item02">
										
											<li class="title">Flavours of Cakes</li>
											<li><a href="my-account">CHEESE CAKE</a></li>
											<li><a href="cart">CHOCOLATE</a></li>
											<li><a href="checkout">UNICORN CAKES</a></li>
											<li><a href="wishlist.html">(SALTED) CARAMEL</a></li>
											<li><a href="my-account">COFFEE</a></li>
											<li><a href="cart">LEMON</a></li>
											<li><a href="my-account">TIRAMISU</a></li>
											<li><a href="cart">MANGO</a></li>
											<li><a href="my-account">VEGAN</a></li>
											<li><a href="cart">GREENTEA MATCHA</a></li>
										</ul>
								...
								<!--
								<li class="drop"><a href="#">Social</a>
									<div class="megamenu dropdown">
										<ul class="item item01">
											<li><a href="about">About Us</a></li>
											<li><a href="my-account">Blog</a></li>
											<li><a href="cart">Facebook</a></li>
											<li class="label2"><a href="#">WhatsApp</a>
												<ul>
													<li><a href="#">+60 0162148065</a></li>
							...
							<div class="footer__widget footer__menu">
								...
								<div class="footer__content">
									...
									<ul class="mainmenu d-flex justify-content-center">
										...
										<li><a href="{{route('index')}}">Best Seller</a></li>
										<li><a href="{{route('index')}}">All Product</a></li>
		...
		<div id="quickview-wrapper">
		    <!-- Modal -->
		    <div class="modal fade" id="productmodal" tab{{route('index')}}="-1" role="dialog">
