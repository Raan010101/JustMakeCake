	        				...
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
	        					<div class="row">
										...
										<div class="product product__style--3">
											<div class="col-lg-3 col-md-4 col-sm-6 col-12">
												<div class="product__thumb">
													<a class="first__img" href="{{route('single-products',['product_id' => $data->id])}}"><img src="images/books/3.jpg" alt="product image"></a>
									...
									<!-- End Single Product Row1-->
											...
											<!-- End Single Product Row2-->

													<!-- Start Single Product Row3-->
													<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
														@foreach($products as $data)
														<div class="product product__style--3">
															<div class="col-lg-3 col-md-4 col-sm-6 col-12">
													...
													<!-- End Single Product Row3-->

														<!-- Start Single Product Row4-->
														<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
															@foreach($products as $data)
															<div class="product product__style--3">
																<div class="col-lg-3 col-md-4 col-sm-6 col-12">
